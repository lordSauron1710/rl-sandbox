...
- **3 Environments:** LunarLander-v2, CartPole-v1, BipedalWalker-v3
...
│   │   │   ├── LeftSidebar.tsx     # Env select + hyperparameters
│   │   │   ├── CenterPanel.tsx     # Live feed + metrics + chart
...
|-------------|--------------|-----------|------------|
| LunarLander-v2 | Discrete (4) | Box(8) | PPO, DQN |
